...
namespace ApiRestNetCore.Controllers
{
    ...
    public class TransactionReportsController : Controller
    {
        ...
        public async Task<ActionResult<TransactionReportsDTO>> Get(int id)
        {
            ...
            var transaction = await context.TransactionReports.FirstOrDefaultAsync(x => x.TransactionReportId == id);
        ...
        public async Task<ActionResult> Post([FromBody] TransactionReportsCreacionDTO transactionCreacionDTO)
        {
            ...
            var transaction = mapper.Map<TransactionReports>(transactionCreacionDTO);
        ...
        public async Task<ActionResult> Put(TransactionReports transaction, int id)
        {
            ...
            if (transaction.TransactionReportId != id)
            {
                return BadRequest("El transaction no existe");
            }

            var existe = await context.TransactionReports.AnyAsync(x => x.TransactionReportId == id);
